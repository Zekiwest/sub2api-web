 ...
 * GEB L3 文件级自指注释块
 * ============================================================================
 * 文件作用: Dashboard 页面，展示使用统计概览、趋势图表、模型分布
 * 依赖关系: lib/usage.ts, stores/auth.ts, lib/i18n, ui/kpi-card, ui/spark-chart, recharts
 * 变更同步:
 *   - 统计指标变化时，需同步 types/index.ts UserDashboardStats
 *   - 图表配置变化时，需检查 Recharts 组件兼容性
 *   - KPI 卡片样式变化时，需更新 ui/kpi-card.tsx
 * ============================================================================
 */
